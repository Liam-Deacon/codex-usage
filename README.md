...
Run codex-usage in a container:
...
# Run interactively
docker run --rm -it ghcr.io/liam-deacon/codex-usage:latest --help

# Check usage (requires Codex auth mounted)
docker run --rm -it \
  -v ~/.codex:/root/.codex:ro \
  ghcr.io/liam-deacon/codex-usage:latest status

# Using docker-compose
docker-compose up codex-usage
```
